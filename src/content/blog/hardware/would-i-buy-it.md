---
title: "Would I Buy the ZimaCube 2 With My Own Money?"
description: "A candid ZimaCube 2 value verdict comparing its $800 base price, RAM and storage upgrades, DIY alternatives, and who should buy it."
category: "Hardware"
date: 2026-05-01
tags:
  - zimacube
...
I didn't pay for my ZimaCube 2. That's the first thing you need to know. I got it free through the [Pioneer programme](/homelab-journal/posts/meta/disclaimer/), and I'm lucky for that. But I've been running it for weeks now, and there's a question I keep circling back to: if I had to pay full price, would I actually pull the trigger?

It's not an easy answer.

## What "Free" Actually Cost Me

The unit [showed up](/homelab-journal/posts/first-impressions/unboxing/) with 8GB of RAM and a 256GB NVMe. That's the standard model. Bare bones. And in my opinion, 8GB is not enough for a machine like this. Most home lab software — Docker containers, VMs, data transfers — eats RAM way faster than it eats cores. I can run a NAS VM on one or two cores no problem. But RAM? That disappears fast.

So I bought a 32GB DDR5 stick. Secondhand, $150. I got lucky on the price. DDR5 isn't cheap.

I already had drives lying around from old projects. Three 1TB 3.5" spinning disks, and four 1TB NVMe sticks I'd picked up on AliExpress years ago for testing. I never throw away storage. Now they're all living in this one machine — two NVMe drives on the motherboard in RAID 1 for [Proxmox](/homelab-journal/posts/homelab-journal/proxmox-primary-os/), two on the adapter card, and the three hard drives in the front bays.
...
The ZimaCube 2 [standard model](/homelab-journal/posts/hardware/overview/) starts at $800. That's the i3-1215U. The Pro model bumps up to an i5-1235U and costs more. There's a Creator Kit too. I didn't even look at the price.

So you're at $800 for the box with 8GB RAM and a 256GB NVMe ([pre-loaded with ZimaOS](/homelab-journal/posts/homelab-journal/zimaos-review/)). Now add the RAM. You're going to want at least 16GB. I'd argue 32GB is the sweet spot. At current DDR5 prices, that's another $150-300.
...
You also get [dual 2.5GbE](/homelab-journal/posts/hardware/overview/). You get [PCIe slots](/homelab-journal/posts/hardware/disassembly/). You get a case that actually fits together without cable management nightmares. You get something that looks like a real product, not a science project.

There's value in that. I just don't know if there's $1,400 of value for *me*.

## The One Thing I'd Change

I'm going to sound picky here. The [power supply](/homelab-journal/posts/hardware/disassembly/) is an external brick with a barrel jack. It works. It's fine.
...
If you're like me — someone [who's been building home labs for years](/homelab-journal/posts/first-impressions/introduction/), who knows how to shop secondhand, who enjoys the jank — the ZimaCube 2 probably isn't the best use of your money. You can build cheaper. You can build weirder. You can build something that does 80% of this for half the price.

But if you want an all-in-one box that you [plug in](/homelab-journal/posts/first-impressions/unboxing/), configure once, and forget about? This is it. Six drive bays, Thunderbolt, 2.5GbE, upgradable RAM, compact and quiet. It really is a one-stop shop.
...
**Related Posts:**
- [Disclosure](/homelab-journal/posts/meta/disclaimer/) — How I got this unit and the bias that comes with it
- [Unboxing](/homelab-journal/posts/first-impressions/unboxing/) — What showed up in the box and first boot
- [Hardware Overview](/homelab-journal/posts/hardware/overview/) — Full specs, ports, and the quirks I noticed
- [Taking It Apart](/homelab-journal/posts/hardware/disassembly/) — Inside the case, the fan situation, and that mystery standoff
- [Why Proxmox Is the Only OS That Makes Sense](/homelab-journal/posts/homelab-journal/proxmox-primary-os/) — How I'm actually using this machine
